sharedComponents.controller(
    ...
    function($rootScope, $scope, $http, $uibModalInstance, mediaService, file,
             w, h, rto, autoSave) {
      var ctrl = this;
      ...
      ctrl.init = function() {
        ...
        if (ctrl.file) {
          setTimeout(() => { ctrl.selectFile([ ctrl.file ]); }, 500);
        }
      ...
      ctrl.combineImage = function() {
        ...
        if (ctrl.canvas) {
          ...
          $scope.$apply(function() {
            ctrl.postedFile.fileStream =
                ctrl.canvas.toDataURL(); // ctx.getImageData(0, 0, 300, 350);
      ...
      ctrl.selectFile = function(files) {
        if (files !== undefined && files !== null && files.length > 0) {
          ...
          ctrl.media.mediaFile.fileName =
              file.name.substring(0, file.name.lastIndexOf("."));
          ctrl.media.mediaFile.extension =
