...
app.controller("RoleController", [
  ...
  function (
    ...
    $scope.initPermissions = async function () {
      ...
      $scope.createUrl = `/portal/mix-database-data/create?mixDatabaseName=sysPermission&dataId=default&guidParentId=${$scope.viewmodel.id}&parentType=Role&backUrl=${backUrl}`;
