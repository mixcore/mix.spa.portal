  ...
  !(function ($) {
    ...
    Collapse.prototype = {
      ...
      transition: function (method, startEvent, completeEvent) {
        var that = this,
          complete = function () {
            "show" == startEvent.type && that.reset(),
      ...
      keydown: function (e) {
        ...
        if (
          ...
          if (
            (($parent = getParent($this)),
            (isActive = $parent.hasClass("open")),
            !isActive || (isActive && 27 == e.keyCode))
          )
            return $this.click();
          ($items = $("[role=menu] li:not(.divider):visible a", $parent)),
            $items.length &&
              ((index = $items.index($items.filter(":focus"))),
              38 == e.keyCode && index > 0 && index--,
              40 == e.keyCode && $items.length - 1 > index && index++,
              ~index || (index = 0),
        ...
        (this.type = type),
          ...
          "click" == this.options.trigger
            ...
            : "manual" != this.options.trigger &&
              ((eventIn =
                "hover" == this.options.trigger ? "mouseenter" : "focus"),
              (eventOut =
                "hover" == this.options.trigger ? "mouseleave" : "blur"),
              this.$element.on(
                eventIn + "." + this.type,
                this.options.selector,
    ...
    Affix.prototype.checkPosition = function () {
      if (this.$element.is(":visible")) {
        ...
        "object" != typeof offset && (offsetBottom = offsetTop = offset),
          "function" == typeof offsetTop && (offsetTop = offset.top()),
          "function" == typeof offsetBottom && (offsetBottom = offset.bottom()),
          (affix =
            null != this.unpin && scrollTop + this.unpin <= position.top
              ? !1
              : null != offsetBottom &&
                position.top + this.$element.height() >=
                  scrollHeight - offsetBottom
              ? "bottom"
              : null != offsetTop && offsetTop >= scrollTop
              ? "top"
              : !1),
          this.affixed !== affix &&
            ((this.affixed = affix),
