    ...
    return (
      (i = {
        buttons: {
          ...
          ok:
            '<a href="#" class="alertify-button alertify-button-ok" id="alertify-ok">{{ok}}</a>',
          cancel:
            '<a href="#" class="alertify-button alertify-button-cancel" id="alertify-cancel">{{cancel}}</a>',
        },
        input:
      ...
      (r = {
        ...
        addListeners: function (e) {
          ...
          (a = function (t) {
            return (
              typeof t.preventDefault != "undefined" && t.preventDefault(),
              p(t),
              typeof y != "undefined" && (s = y.value),
              typeof e == "function" &&
                (typeof y != "undefined" ? e(!0, s) : e(!0)),
              !1
            );
          }),
            (h = function (t) {
            ...
            (p = function (e) {
              u.hide(),
                u.unbind(n.body, "keyup", d),
                u.unbind(c, "focus", v),
                i && u.unbind(g, "submit", a),
                t && u.unbind(l, "click", a),
                r && u.unbind(f, "click", h);
            }),
            (d = function (e) {
              var t = e.keyCode;
            ...
            this.bind(c, "focus", v),
            t && this.bind(l, "click", a),
            r && this.bind(f, "click", h),
            this.bind(n.body, "keyup", d),
            i && this.bind(g, "submit", a),
            typeof this.transition == "undefined" && this.setFocus();
        },
        bind: function (e, t, n) {
        ...
        build: function (e) {
          var t = "",
            ...
            s = e.message,
            o = e.cssClass || "";
          (t += '<div class="alertify-dialog">'),
            r.buttonFocus === "none" &&
              (t +=
                '<a href="#" id="alertify-noneFocus" class="alertify-hidden"></a>'),
            n === "prompt" && (t += '<form id="alertify-form">'),
            (t += '<article class="alertify-inner">'),
            (t += i.message.replace("{{message}}", s)),
            n === "prompt" && (t += i.input),
            (t += i.buttons.holder),
            (t += "</article>"),
            n === "prompt" && (t += "</form>"),
          ...
          switch (n) {
            case "confirm":
              (t = t.replace(
                "{{buttons}}",
                this.appendButtons(i.buttons.cancel, i.buttons.ok)
              )),
                (t = t
            ...
            case "prompt":
              (t = t.replace(
                "{{buttons}}",
                this.appendButtons(i.buttons.cancel, i.buttons.submit)
              )),
                (t = t
                  .replace("{{ok}}", this.labels.ok)
                  .replace("{{cancel}}", this.labels.cancel));
              break;
            case "alert":
              (t = t.replace("{{buttons}}", i.buttons.ok)),
                (t = t.replace("{{ok}}", this.labels.ok));
              break;
            default:
          }
          return (
            (v.className = "alertify alertify-show alertify-" + n + " " + o),
            (d.className = "alertify-cover"),
            t
          );
        },
        close: function (e, t) {
          ...
          this.bind(e, "click", function () {
            ...
            (i = function (e) {
              typeof e != "undefined" &&
                e.parentNode === m &&
                (typeof r.transition != "undefined"
                  ? (r.bind(e, r.transition, s),
        ...
        dialog: function (e, t, r, i, o) {
          ...
          return (
            typeof this.init == "function" && (this.init(), a()),
            u.push({
              type: t,
              message: e,
              callback: r,
          ...
          u.splice(0, 1),
            u.length > 0
              ...
              : ((s = !1),
                (e = function (n) {
                  n.stopPropagation(),
                    (v.className += " alertify-isHidden"),
                    t.unbind(v, t.transition, e);
                }),
                typeof this.transition != "undefined"
                  ? (this.bind(v, this.transition, e),
                    (v.className = "alertify alertify-hide alertify-hidden"))
                  : (v.className =
                      "alertify alertify-hide alertify-hidden alertify-isHidden"),
                (d.className = "alertify-cover alertify-cover-hidden"),
                p.focus());
        },
        init: function () {
          n.createElement("nav"),
            ...
            d.setAttribute("id", "alertify-cover"),
            (d.className = "alertify-cover alertify-cover-hidden"),
            n.body.appendChild(d),
            (v = n.createElement("section")),
            v.setAttribute("id", "alertify"),
            (v.className = "alertify alertify-hidden"),
            n.body.appendChild(v),
            (m = n.createElement("section")),
            m.setAttribute("id", "alertify-logs"),
            (m.className = "alertify-logs alertify-logs-hidden"),
        ...
        log: function (e, t, n) {
          ...
          return (
            typeof this.init == "function" && (this.init(), r()),
        ...
        notify: function (e, t, r) {
          ...
          (i.className =
            "alertify-log" +
            (typeof t == "string" && t !== "" ? " alertify-log-" + t : "")),
            (i.innerHTML = e),
        ...
        setup: function () {
          ...
          (s = !0),
            ...
            typeof this.transition != "undefined" &&
              this.bind(v, this.transition, i),
            (v.innerHTML = this.build(e)),
            (c = a("alertify-resetFocus")),
            (l = a("alertify-ok") || t),
            (f = a("alertify-cancel") || t),
            (h =
              r.buttonFocus === "cancel"
                ? f
                : r.buttonFocus === "none"
                ? a("alertify-noneFocus")
                : l),
            (y = a("alertify-text") || t),
            (g = a("alertify-form") || t),
            typeof e.placeholder == "string" &&
              e.placeholder !== "" &&
              (y.value = e.placeholder),
            this.addListeners(e.callback);
        },
