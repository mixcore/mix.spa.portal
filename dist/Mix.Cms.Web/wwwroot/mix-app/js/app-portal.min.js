/* Sun Feb 14 2021 18:37:28 GMT+0700 (Indochina Time) */"use strict";
...
app.factory('MixRestAttributeSetPortalService', ['BaseService', 'CommonService', function (baseService, commonService) {
    ...
    var _import = async function (mixDatabaseName, file) {
        var url = (this.prefixUrl || '/' + this.lang + '/'
            + this.modelName) + '/import-data/' + mixDatabaseName;
...
app.controller('AttributeSetController', [
    ...
    function ($scope, $rootScope, $location,
        ngAppSettings, $routeParams, mixDatabaseColumnService, service) {
    ...
    [
        ...
        function ($scope, $rootScope, ngAppSettings, $routeParams, $location,
            ...
            $scope.getList = async function () {
                ...
                var response = await service.getList('read', $scope.request, $scope.mixDatabaseId, $scope.mixDatabaseName, type, parentId);
                $scope.canDrag = $scope.request.orderBy !== 'Priority' || $scope.request.direction !== '0';
                if (response) {
                    $scope.data = response;
                    $rootScope.isBusy = false;
            ...
            $scope.getSingle = async function () {
                ...
                $scope.mixDatabaseId = $routeParams.mixDatabaseId;
                $scope.mixDatabaseName = $routeParams.mixDatabaseName;
                var resp = await service.getSingle('portal', [id, $scope.mixDatabaseId, $scope.mixDatabaseName]);
                if (resp) {
            ...
            $scope.edit = function (data) {
                $scope.goToPath('/portal/mix-database-data/details?dataId=' + data.id + '&mixDatabaseId=' + $scope.mixDatabaseId)
            };
            $scope.remove = function (data) {
...
app.component('mixDatabaseEdm', {
    templateUrl: '/mix-app/views/app-portal/pages/mix-database/components/edm/view.html',
...
app.component('mixDatabaseMain', {
    templateUrl: '/mix-app/views/app-portal/pages/mix-database/components/main/view.html',
    controller: ['$rootScope', function ($rootScope) {
        var ctrl = this;
        ctrl.settings = $rootScope.globalSettings;
...
app.component('postAttributeSet', {
    templateUrl: '/mix-app/views/app-portal/pages/post/components/mix-database/view.html',
    bindings: {
        set: '=',
        parentType: '=?',
        parentId: '=?',
    ...
    controller: ['$rootScope', '$scope', 'RestRelatedAttributeSetPortalService', 'RestAttributeSetPortalService',
        function ($rootScope, $scope, navService, dataService) {
            ...
            ctrl.removeValueConfirmed = async function (nav) {
                ...
                if (result.isSucceed) {
                    $rootScope.removeObjectByKey(ctrl.set.mixDatabase.postData.items, 'id', nav.id);
                    $rootScope.isBusy = false;
                    $scope.$apply();
                }
                else {
                ...
                dataService.save('portal', data).then(resp => {
                    if (resp.isSucceed) {
                        ...
                        navService.save('portal', ctrl.viewModel).then(resp => {
                            if (resp.isSucceed) {
                                var tmp = $rootScope.findObjectByKey(ctrl.set.mixDatabase.postData.items, ['parentId', 'parentType', 'id'],
...
app.component('themeExportAttributeSets', {
    templateUrl: '/mix-app/views/app-portal/pages/theme/components/theme-export-mix-databases/view.html',
    controller: ['$rootScope', '$scope', 'ngAppSettings', function ($rootScope, $scope) {
        var ctrl = this;
        ctrl.updateAttributeSetExport = function () {
            ctrl.selectedExport.mixDatabases = angular.copy($rootScope.filterArray(ctrl.exportData.mixDatabases, ['isActived'], [true]));
...
modules.component('mixDatabaseDataFilter', {
    templateUrl: '/mix-app/views/app-portal/components/mix-database-data-filter/view.html',
    bindings: {
        query: '=',
        mixDatabaseName: '=?',
        mixDatabaseId: '=?',
...
modules.component('mixDatabaseNavData', {
    templateUrl: '/mix-app/views/app-portal/components/mix-database-nav-data/view.html',
    bindings: {
        nav: '=',
        parentId: '=',
        parentType: '=',
...
modules.component("mixDatabaseNavValues", {
  templateUrl: "/mix-app/views/app-portal/components/mix-database-nav-values/view.html",
  bindings: {
    mixDatabaseId: "=",
    mixDatabaseName: "=",
    parentId: "=",
...
modules.component("mixDatabaseNavs", {
  templateUrl: "/mix-app/views/app-portal/components/mix-database-navs/view.html",
  bindings: {
    parentId: "=",
    parentType: "=",
    mixDatabaseNavs: "=?",
...
modules.component("mixDatabaseDataValues", {
  templateUrl:
    "/mix-app/views/app-portal/components/mix-database-values/mix-database-values.html?v=2",
  bindings: {
    header: "=",
    data: "=",
    canDrag: "=",
  ...
  controller: [
    ...
    function (
      ...
      ctrl.loadHelperUrl = function () {
        ...
        if (portalUrl.startsWith("/portal/mix-database-data/list?mixDatabaseId=2")) {
        ...
        if (portalUrl.startsWith("/portal/mix-database-data/list?mixDatabaseId=7")) {
          ctrl.trustedUrl = $sce.trustAsResourceUrl(defaultUrl + "/basic-usage-category");
        }
        if (portalUrl.startsWith("/portal/mix-database-data/list?mixDatabaseId=8")) {
...
modules.component('postAttributeSetForm', {
    templateUrl: '/mix-app/views/app-portal/components/post-mix-database-form/view.html',
    bindings: {
        setId: '=',
        data: '=',
        attributes: '=',
...
modules.component('postAttributeSetValues', {
    templateUrl: '/mix-app/views/app-portal/components/post-mix-database-values/view.html',
    bindings: {
        header: '=',
        data: '=',
        columns: '=?',
